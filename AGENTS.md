...
This project is indexed by GitNexus as **maverick-mcp** (21273 symbols, 38042 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
