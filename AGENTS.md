...
This project is indexed by GitNexus as **maverick-mcp** (20618 symbols, 37130 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
