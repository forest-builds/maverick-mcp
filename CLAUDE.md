...
This project is indexed by GitNexus as **maverick-mcp** (21774 symbols, 38796 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
